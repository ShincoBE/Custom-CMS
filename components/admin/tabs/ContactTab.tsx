...
const ContactTab = ({ content, handleContentChange, handleModalImageUpload }: ContactTabProps) => {
    ...
    return (
        <>
            ...
            <div className="mb-6 p-4 border border-zinc-700 rounded-lg bg-zinc-800/50">
                <h3 className="text-lg font-semibold mb-3 text-white">Contact Kaarten</h3>
            ...
            <div className="mb-6 p-4 border border-zinc-700 rounded-lg bg-zinc-800/50">
                 <h3 className="text-lg font-semibold mb-3 text-white">Offerteformulier E-mails</h3>
                 <div className="mb-6 p-4 bg-zinc-900/50 border border-zinc-600 rounded-lg text-sm text-zinc-300">
